...
namespace CapsWriterSharp.Platform.Windows.Notifications;
...
public sealed class WindowsToastNotifier : INotificationService
{
    ...
    {
        NotificationKind.Success => "CapsWriterSharp · Success",
        NotificationKind.Warning => "CapsWriterSharp · Warning",
        NotificationKind.Error => "CapsWriterSharp · Error",
        _ => "CapsWriterSharp",
    };
}
